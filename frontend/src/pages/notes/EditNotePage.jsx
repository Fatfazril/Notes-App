      ...
      <aside className="hidden md:flex w-64 flex-col border-r border-[#f0f2f4] dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0 transition-colors duration-200">
        <div className="p-6 flex flex-col h-full">
          ...
          <div className="mt-auto pt-4 border-t border-[#f0f2f4] dark:border-slate-800">
             <Link to={`/notes/${id}`} className="w-full flex items-center justify-center gap-2 text-[#616f89] hover:text-[#111318] dark:text-slate-400 dark:hover:text-white font-medium py-2 rounded-xl transition-all">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        <form onSubmit={handleSubmit} className="flex flex-col h-full">
            ...
            <div className="flex items-center gap-4">
                <Link to={`/notes/${id}`} className="md:hidden p-2 -ml-2 text-[#616f89] hover:bg-[#f0f2f4] dark:hover:bg-slate-800 rounded-lg transition-colors">
                    <span className="material-symbols-outlined">arrow_back</span>
                </Link>
                <div className="flex items-center gap-2 text-[#616f89] dark:text-slate-400">
                    <span className="material-symbols-outlined text-[20px]">edit_document</span>
                    <span className="text-sm font-medium">Editing Note</span>
                </div>
            </div>
